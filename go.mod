...
require (
	...
	golang.zx2c4.com/wireguard/windows v0.2.1
	gvisor.dev/gvisor v0.0.0-20201118073614-a5e3fd1b29e1
)

replace gvisor.dev/gvisor => gvisor.dev/gvisor v0.0.0-20201118073926-62939087675d

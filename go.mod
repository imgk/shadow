...
require (
	...
	github.com/imgk/divert-go v0.0.0-20201127012229-e281673e8d6e
	...
	golang.zx2c4.com/wireguard/windows v0.3.2
	gvisor.dev/gvisor v0.0.0-20201127205929-1913cff58732
)
